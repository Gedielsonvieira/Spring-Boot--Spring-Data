...
@Repository
public interface FuncionarioRepository extends CrudRepository<Funcionario, Integer>, ListPagingAndSortingRepository<Funcionario, Integer> {
    //Derived query
    ...
    //Native Query
    @Query(value = "SELECT * FROM alura.funcionarios f WHERE f.data_contratacao >= :dataContratacao", nativeQuery = true)
